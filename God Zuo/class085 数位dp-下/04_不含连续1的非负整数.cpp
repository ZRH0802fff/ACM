...
int cnt[31]; // cnt[len] : 二进制如果有len位，所有二进制状态中不存在连续的1的状态有多少个，辅助数组
...
public:
    ...
    int findIntegers(int n) {
        return findIntegers2(n);
    }
};

int main() {
    Solution sol;
    cout << "n=5: " << sol.findIntegers(5) << " (expected 5)" << endl;
    cout << "n=1: " << sol.findIntegers(1) << " (expected 2)" << endl;
    cout << "n=2: " << sol.findIntegers(2) << " (expected 3)" << endl;
    return 0;
}
