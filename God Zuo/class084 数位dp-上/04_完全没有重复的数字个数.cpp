...
int main() {
    Solution sol;
    cout << "n=20: " << sol.countSpecialNumbers(20) << " (expected 19)" << endl;
    cout << "n=5: " << sol.countSpecialNumbers(5) << " (expected 5)" << endl;
    cout << "n=135: " << sol.countSpecialNumbers(135) << " (expected 110)" << endl;
    return 0;
}
