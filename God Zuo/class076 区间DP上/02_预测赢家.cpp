...
int main() {
    ...
    cout << "nums = [1, 5, 2], 预期: false" << endl;
    cout << "暴力: " << (sol.predictTheWinner1(nums1) ? "true" : "false") << endl;
    cout << "记忆化: " << (sol.predictTheWinner2(nums1) ? "true" : "false") << endl;
    cout << "动态规划: " << (sol.predictTheWinner3(nums1) ? "true" : "false") << endl;
    cout << endl;

    vector<int> nums2 = {1, 5, 233, 7};
    cout << "nums = [1, 5, 233, 7], 预期: true" << endl;
    cout << "暴力: " << (sol.predictTheWinner1(nums2) ? "true" : "false") << endl;
    cout << "记忆化: " << (sol.predictTheWinner2(nums2) ? "true" : "false") << endl;
    cout << "动态规划: " << (sol.predictTheWinner3(nums2) ? "true" : "false") << endl;
